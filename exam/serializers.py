...
class RegularUserLoginSerializer(serializers.Serializer):
    username = serializers.RegexField(regex=r'^(PRP|prp|LPRP|lprp)[0-9]{2}([A-Za-z]{2}|[0-9]{2})[0-9]{3}$', help_text = 'Username should be your college reg-number starting with PRP')
...
class RegularUserSerializer(serializers.ModelSerializer):
    ...
    username = serializers.RegexField(regex=r'^(PRP|prp|LPRP|lprp)[0-9]{2}([A-Za-z]{2}|[0-9]{2})[0-9]{3}$', help_text = 'Enter a valid PRP code')
